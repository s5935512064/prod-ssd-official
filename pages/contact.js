...
const Contact = () => {
    return (
        <Layout>
            <div className="h-[45vh] md:h-[65vh] w-full bg-[url('/assets/DSCF1535.webp')] bg-cover bg-center bg-no-repeat bg-black/30 bg-blend-multiply flex justify-center items-center px-4 md:px-10 xxl:px-0 ">
                <div className="text-center gap-2 flex flex-col">
                    <h1 className="text-2xl md:text-5xl font-semibold text-white drop-shadow uppercase">GET IN TOUCH WITH US</h1>
            ...
            <div className="min-h-screen w-full flex justify-center">
                ...
                <div className="max-w-7xl w-full h-full relative   px-4 md:px-10 xxl:px-0 flex flex-col gap-4">
                    ...
                    <div className="w-full flex flex-wrap gap-4 py-10  ">
                        ...
                        <div className="max-w-md w-full flex flex-col gap-2 ">
                            ...
                            <p className="text-sm font-light">
                                130-132 Sindhorn Building Tower 1,<br /> 4th Floor,
                                Wireless Road, Lumpini,<br /> Pathumwan, Bangkok 10330</p>

                            <p className="text-sm font-light">	02-263-2500</p>
                        </div>

                        <div className="max-w-md w-full flex flex-col gap-2 ">


                            <p className="text-sm font-light">	More way to follow us.</p>
                            <div className="flex items-center gap-2 ">
                                <Link href="https://www.instagram.com/polo_football_park/">
                                    <a target="_blank" rel="noopener noreferrer" aria-label="instragram">
                                        <svg
                                ...
                                <Link href="https://page.line.me/ewb3453i?openQrModal=true">
                                    <a target="_blank" rel="noopener noreferrer" aria-label="line">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="33.492"
                                            height="33.499"
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2740.5422535950306!2d100.54357764972166!3d13.7358769638786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29ed8c27d54c3%3A0xf0cac239028d16c0!2z4Lit4Liy4LiE4Liy4Lij4Liq4Li04LiZ4LiY4LijIOC5geC4guC4p-C4hyDguKXguLjguKHguJ7guLTguJnguLUg4LmA4LiC4LiV4Lib4LiX4Li44Lih4Lin4Lix4LiZIOC4geC4o-C4uOC4h-C5gOC4l-C4nuC4oeC4q-C4suC4meC4hOC4oyAxMDMzMA!5e0!3m2!1sth!2sth!4v1663654804445!5m2!1sth!2sth" width="100%"
                        height="500"
                        allowFullScreen=""
                        loading="lazy"
