...
const Footer = () => {
    return (
        <>
            <div className=" px-4 md:px-10 xxl:px-0 z-50! relative  h-full w-full flex flex-col items-center justify-center py-6 bg-[#A08A58]">
                <div className="max-w-7xl w-full h-full flex  items-center pb-2">
                    <div className="pb-1 w-full flex flex-col sm:flex-row  gap-3  h-full justify-between items-center text-white ">
                        ...
                        {/* <div className="inline-flex items-center">
                            <button onClick={scrollToTop} className="text-sm rounded-full grid justify-items-center items-center">
                                <p className="text-white text-xs  sm:ml-3">
                                    SCROLL TO TOP
                                </p>
                ...
                <div className=" max-w-7xl w-full h-full flex flex-col sm:flex-row justify-between items-center  border-t border-[#FFF]">

                    <div className=" py-2 h-full items-center lg:border-0 w-full sm:w-fit">
                        <p className="text-[#FFF] text-xs text-center ">
                            Copyright © 2022 Siam Sindhorn Co., Ltd. All rights reserved.
                        </p>
                    </div>

                    <div className="py-2  flex  gap-3  h-full justify-center items-center text-[#FFF]">

                        <div className="w-full flex  divide-x divide-[#FFF] justify-center lg:justify-start gap-3 border-[#FFF]   ">

                            <p className=" text-xs cursor-pointer -ml-3 sm:ml-0 sm:pl-3  ">
                                Cookie Consent
                            </p>
                            ...
                            <Link href={"/privacy"}>
                                ...
                                <a target="_blank" rel="noopener noreferrer" className=" text-xs pl-3 cursor-pointer ">
                                    Privacy Policy
                                </a>
                            </Link>
                        </div>
